...
import { AppNote, AppTask, LoreEntry, PomodoroConfig, UserPreferences, Project, UserNoteTemplate, PlotOutlineNode, LongformDocument } from '../../../types'; // Added UserNoteTemplate, PlotOutlineNode, LongformDocument
