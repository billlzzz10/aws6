...
import { onRequest, Request as FirebaseRequest, HttpsResponse } from "firebase-functions/v2/https";
import express, { Request as ExpressRequest, Response as ExpressResponse, Application, NextFunction } from "express";
...
// Cast app to `any` to satisfy the HttpsFunction signature for onRequest.
// This is a common pattern when TypeScript definitions don't perfectly align
// with Firebase's runtime flexibility for Express apps.
